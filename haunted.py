...
async def blacklist(ctx: commands.Context): 
 ...
 embed = discord.Embed(color=bot.color, description="Do you **agree** to our privacy policy and for your data to be used for commands?\n**DISAGREEING** will result in a blacklist from using bot's commands")
 ...
 async def no_callback(interaction: discord.Interaction):
    ...
    await interaction.response.edit_message(embed=discord.Embed(color=bot.color, description=f"You got blacklisted from using bot's commands."), view=None)
    return 
