...
class edit(commands.Cog):
    ...
    @Mod.is_mod_configured()
    @tedit.command(name='adduser', description='add a user to a thread', brief="manage channels", usage="[thread] @qnok")
    @Permissions.has_permission(manage_threads=True)
    ...
    @Mod.is_mod_configured()
    @tedit.command(name='removeuser', description='remove a user from the thread', brief="manage channels", usage="[thread] @qnok")
    @Permissions.has_permission(manage_threads=True)
