...
class misc(commands.Cog):
  ...
  @naughtycorner.command( name="add", brief="timeout members", description="add a member to the naughty corner", usage="@qnok")
  ...
  @naughtycorner.command( name="remove", brief="timeout emmbers", description="remove a member from the naughty corner", usage="@qnok")
  @Permissions.has_permission(manage_guild=True)
  @is_detention()
  ...
  @Permissions.has_permission(manage_guild=True)
  async def webhook_create(self, ctx: commands.Context, channel: discord.TextChannel, *, name: str="haunted"): 
  ...
  @Permissions.has_permission(manage_guild=True)
  async def webhook_send(self, ctx: HauntedContext, code: ValidWebhookCode, *, script: EmbedScript=None):
