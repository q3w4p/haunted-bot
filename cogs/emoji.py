    ...
    async for message in ctx.channel.history(limit=10): 
      ...
      if message.stickers: 
        ...
        if s.guild_id == ctx.guild.id: 
         ...
         button1 = discord.ui.Button(emoji="<:check:1451659525986848878>")
         button2 = discord.ui.Button(emoji="<:deny:1451659356448755763>")
     ...
     if ctx.message.stickers:
      ...
      async for message in ctx.channel.history(limit=10):
       ...
       if message.stickers:
        ...
        button1 = discord.ui.Button(label="", style=discord.ButtonStyle.gray, emoji="<:check:1451659525986848878>")
        button2 = discord.ui.Button(label="", style=discord.ButtonStyle.gray, emoji="<:deny:1451659356448755763>")
