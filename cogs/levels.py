...
class leveling(commands.Cog): 
  ...
  @commands.command(description="check any members rank", usage="@qnok")
  ...
  @level.command(name="reset", description="reset levels for a member, leave blank for everyone", brief="administrator", usage="@qnok")
  @Permissions.has_permission(administrator=True) 
