...
class CreateTicket(discord.ui.View): 
    ...
    async def create(self, interaction: discord.Interaction, button: discord.ui.Button):      
        ...
        if len(results) == 0: 
           ...
           embed.set_footer(text="haunted.cc", icon_url=interaction.client.user.display_avatar.url)
        ...
        async def select_callback(inte: discord.Interaction):   
            ...
            e.set_footer(text="haunted.cc", icon_url=interaction.client.user.display_avatar.url)
...
class tickets(commands.Cog): 
    ...
    @ticket.command(description="add a person to the ticket", usage="@qnok", brief="manage channels")
    ...
    @ticket.command(description="remove a member from the ticket", usage="@qnok", brief="manage channels")
    @Permissions.has_permission(manage_channels=True)
    @get_ticket() 
