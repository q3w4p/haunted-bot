...
class donor(commands.Cog):
  ...
  @commands.command(description="uwuify a person's messages", usage="@qnok", brief="donor & manage messages")
  ...
  async def uwulock(self, ctx: commands.Context, *, member: discord.Member):
    ...
    return await ctx.message.add_reaction("<:check:1451659525986848878>")
  ...
  @commands.command(aliases=['stfu'], description="delete a person's messages", usage="@qnok", brief="donor & manage messages")
  @Permissions.has_permission(manage_messages=True)
  ...
  @commands.command(description="force nickname a user", usage="@qnok [nickname]", aliases=["locknick", "fn"], brief="manage nicknames & donor")
  ...
  @commands.group(invoke_without_command=True, name="reskin", description="customize haunteds output embeds")    
  async def reskin(self, ctx: commands.Context):
    return await ctx.create_pages()
  
  @reskin.command(name="enable", description="customize haunteds output embeds", aliases=['on'], brief="donor")
  ...
  @reskin.command(name="name", description="change the name used on haunteds output embeds", brief="donor")
  ...
  @reskin.command(name="avatar", description="change the icon used on haunteds output embeds", aliases=['av'], brief="donor")
