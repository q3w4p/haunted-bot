...
class settings(commands.Cog):
    ...
    async def enable(self, ctx: commands.Context):
        ...
        await ctx.bot.db.execute("INSERT INTO settings_social VALUES ($1, $2, $3) ON CONFLICT (guild_id) DO UPDATE SET toggled = $2 WHERE settings_social.guild_id = $1", ctx.guild.id, True, 'haunted')
    ...
    async def disable(self, ctx: commands.Context):
        ...
        await ctx.bot.db.execute("INSERT INTO settings_social VALUES ($1, $2, $3) ON CONFLICT (guild_id) DO UPDATE SET toggled = $2 WHERE settings_social.guild_id = $1", ctx.guild.id, False, 'haunted')
