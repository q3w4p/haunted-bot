...
class antiraid(commands.Cog): 
    ...
    @antiraid.command(brief="server owner", aliases=["wl"], description="whitelist an user so they can use antiraid commands", help="antiraid", usage="@qnok")
    ...
    @antiraid.command(brief="server owner", aliases=["uwl"], description="unwhitelist an user from antiraid commands", help="antiraid", usage="@qnok") 
    @Permissions.server_owner()
    ...
    @newaccounts.command(brief="antiraid whitelisted", name="unwhitelist", description="remove the whitelist of a new account", help="antiraid", usage="@qnok", aliases=['uwl'])
    @check_whitelist("antiraid")
    async def newaccounts_unwhitelist(self, ctx: commands.Context, *, member: discord.User): 
     ...
     return await ctx.warning(f"**{member}** is not whitelisted for **antiraid newaccounts** anymore")  
    ...
    @defaultavatar.command(brief="antiraid whitelisted", name="unwhitelist", description="remove the whitelist of a no avatar member", help="antiraid", usage="@qnok", aliases=['uwl'])
    @check_whitelist("antiraid")
    async def defaultavatar_unwhitelist(self, ctx: commands.Context, *, member: discord.User): 
     ...
     return await ctx.warning(f"**{member}** is not whitelisted for **antiraid defaultavatar** anymore")  
