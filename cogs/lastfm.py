...
class lastfm(commands.Cog):
    ...
    @lf_embed.command(name="steal", description="steal someone's custom lastfm embed", usage="@qnok")
    ...
    @lastfm.command(name="topartists", aliases = ['ta', "tar"], description="check a member's top 10 artists", usage="@qnok")
    ...
    @lastfm.command(name="toptracks", aliases = ['tt'], description="check a member's top 10 tracks", usage="@qnok")
    ...
    async def lf_login(self, ctx: commands.Context):
        ...
        embed = Embed(
            ...
            description=(
                f"Authorize **haunted** to use your Last.fm account [here]({auth_url}). "
                "Your library's data will be indexed to power the whoknows commands and other commands.\n\n"
                "If you want to remove your account with **haunted**, run `lastfm logout` and visit your settings on "
    ...
    @lastfm.command(name="topalbums", aliases = ['tal'], description="check a member's top 10 albums", usage="@qnok")
    ...
    @lastfm.command(name="cover", description="get the cover image of your lastfm song", usage="@qnok")
    ...
    async def lf_howto(self, ctx: commands.Context): 
      await ctx.lastfm_message("instructions can be viewed at <https://new-docs.haunted.cc/configuration/lastfm>")
    ...
    async def lf_chart(self, ctx: commands.Context, user: discord.User=None, size: str = "3x3", period: Literal['overall', '7day', '1month', '3month', '6month', '12month'] = 'overall'):
      ...
      headers = {"api-key": self.bot.haunted_api}
    ...
    @commands.command(aliases = ['tal'], description="check a member's top 10 albums", usage="@qnok")
    ...
    @commands.command(aliases = ['tt'], description="check a member's top 10 tracks", usage="@qnok")
    ...
    @commands.command(aliases = ['ta', "tar"], description="check a member's top 10 artists", usage="@qnok")
