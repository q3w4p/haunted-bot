...
class config(Cog):
    ...
    async def variables(self, ctx: Context): 
     ...
     embed = Embed(color=self.bot.color, description="to view variables visit https://haunted.cc/variables")
    ...
    async def mediaonly_remove(self, ctx: Context, *, channel: TextChannel=None):
     if channel is not None: 
      ...
      return await ctx.warning(f"The channel {channel.mention} isn't a **mediaonly** channel anymore.")
    ...
    async def poj_remove(self, ctx: Context, *, channel: TextChannel=None): 
      ...
      if channel is not None: 
        ...
        return await ctx.warning(f"I will not ping new members in {channel.mention}.")
      ...
      return await ctx.warning("I will **not** ping new members in any channel.") 
    ...
    async def counter_types(self, ctx: Context):
      embed = Embed(color=self.bot.color, description="to view counters visit https://haunted.cc/counters")
      await ctx.reply(embed=embed)
