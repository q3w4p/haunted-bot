...
from bot.helpers import HauntedContext

class ValidTime(commands.Converter):
  async def convert(self, ctx: HauntedContext, argument: int):
   try: 
...
class ClearMod(discord.ui.View): 
  ...
  @discord.ui.button(emoji="<:check:1451659525986848878>")
  ...
  @discord.ui.button(emoji="<:deny:1451659356448755763>")
...
class moderation(commands.Cog): 
  ...
  async def setmod(self, ctx: commands.Context): 
   ...
   await ctx.typing()
   role = await ctx.guild.create_role(name="haunted-jail")
   ...
   category = await ctx.guild.create_category(name="haunted mod", overwrites=over)
  ...
  @Mod.is_mod_configured()
  @commands.command(description="restore member's roles", brief="manage roles", usage="@qnok", help="moderation")
  ...
  @Mod.is_mod_configured()
  @commands.command(aliases=["setnick", "nick"], description="change an user's nickname", usage="@qnok <nickname>", help="moderation")
  ...
  @Mod.is_mod_configured()
  @commands.command(description="kick members from your server", brief="kick members", usage="@qnok <reason>")
  ...
  @Mod.is_mod_configured()
  @commands.command(description="ban members from your server", brief="ban members", usage="@qnok <reason>")
  ...
  @Mod.is_mod_configured()
  @commands.command(description="unban an user", usage="@qnok [reason]")
  @Permissions.has_permission(ban_members=True)
  ...
  @Mod.is_mod_configured()
  @commands.command(description="ban an user then immediately unban them", usage="@qnok [reason]")
  @Permissions.has_permission(ban_members=True)
  ...
  @Mod.is_mod_configured()
  @commands.command(description="unmute a member in your server", brief="moderate members", usage="@qnok <reason>", aliases=["untimeout"])
  @Permissions.has_permission(moderate_members=True)
  ...
  @Mod.is_mod_configured()
  @commands.command(aliases=['vcmute'], description="mute a member in a voice channel", brief="moderate members", usage="@qnok", help="moderation")
  @Permissions.has_permission(moderate_members=True)
  ...
  @Mod.is_mod_configured()
  @commands.command(aliases=['vcunmute'], description="unmute a member in a voice channel", brief="moderate members", usage="@qnok", help="moderation")
  @Permissions.has_permission(moderate_members=True)
  ...
  @Mod.is_mod_configured()
  @commands.command(help="removes all staff roles from a member", description="moderation", brief="administrator", usage="@qnok [reason]")
  @Permissions.has_permission(administrator=True)
  ...
  @Mod.is_mod_configured()
  @commands.command(name='warn', help="warn a member", brief="manage messages", usage="@qnok [reason]")
  @Permissions.has_permission(manage_messages=True) 
  ...
  @Mod.is_mod_configured()
  @commands.command(name='warnclear', description="clear all warns from an user", usage="@qnok", brief="manage messages")
  @Permissions.has_permission(manage_messages=True) 
  ...
  @Mod.is_mod_configured()
  @commands.command(name='warnlist', aliases=['warns'], description="shows all warns of an user", usage="@qnok")
  @Permissions.has_permission(manage_messages=True) 
  ...
  @Mod.is_mod_configured()
  @commands.command(description="jail a member", usage="@qnok", brief="manage channels")
  @Permissions.has_permission(manage_channels=True) 
  ...
  @Mod.is_mod_configured()
  @commands.command(description="unjail a member", usage="@qnok [reason]", brief="manage channels")
  @Permissions.has_permission(manage_channels=True) 
  ...
  @Mod.is_mod_configured()
  @Permissions.has_permission(manage_channels=True)  
  @commands.command(name='imute', description='remove image permissions from a member', usage='@qnok [channel]', brief="manage channels")
  ...
  @Mod.is_mod_configured()
  @Permissions.has_permission(manage_channels=True)
  @commands.command(name='iunmute', description='restore image permissions to a member', usage='@qnok [channel]', brief="manage channels")
  ...
  @Mod.is_mod_configured()
  @Permissions.has_permission(manage_channels=True)
  @commands.command(name='rmute', description='remove reaction permissions from a member', usage='@qnok [channel]', brief="manage channels")
  ...
  @Mod.is_mod_configured()
  @Permissions.has_permission(manage_channels=True)
  @commands.command(name='runmute', description='restore reaction permissions to a member', usage='@qnok [channel]', brief="manage channels")
