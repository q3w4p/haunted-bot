...
class voicemaster(commands.Cog):
   ...
   @voice.command(description="let someone join your locked voice channel", usage="@qnok", brief="vc owner")
   @check_vc_owner()
   ...
   @voice.command(description="restrict someone from joining your voice channel", usage="@qnok", brief="vc owner")
   @check_vc_owner()
   ...
   @voice.command(name="kick", description="kick a member from your voice channel", usasge="@qnok", brief="vc owner")
   @check_vc_owner()
   ...
   @voice.command(description="transfer the voice channel ownership to another member", usage="@qnok", brief="vc owner")
   @check_vc_owner()
