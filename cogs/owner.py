...
class owner(commands.Cog):
   ...
   async def restart(self, ctx: commands.Context):
    ...
    os.system("pm2 restart haunted")

   @commands.is_owner()
   @commands.command(aliases=["guilds"], name='servers', description="list all the servers haunted is in", brief="bot owner")
   ...
   @commands.is_owner()
   @commands.command(description="globally uwuify a person's messages", usage="@qnok", brief="bot owner")
