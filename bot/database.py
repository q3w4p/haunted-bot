...
async def create_db(self: commands.Bot): 
    """Create all required database tables for Haunted Bot"""
    ...
    # Economy
    await self.db.execute("CREATE TABLE IF NOT EXISTS economy (user_id BIGINT PRIMARY KEY, bucks INTEGER DEFAULT 0)")
